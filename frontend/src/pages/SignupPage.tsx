...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Call signup API endpoint - always sign up as TUTOR
      await signup(email, password, firstName, lastName, "TUTOR");
    ...
    <div className="auth-container">
      <div className="auth-card">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Join Rainfall as a tutor</p>
        </div>
